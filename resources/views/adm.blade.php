...
<html lang="en">
  ...
  <body>
    <div class="question-container">
      <font size ="2"> <center><h1>PENILAIAN TAD ADMINISTRASI</h1></center></font>
      <div class="select-menu">
            <div class="form-group">
              ...
              <ul class="options">
                <li class="option">
                  <span class="option-text">AKHMAD FAJRILLAH</span>
                </li>
                <li class="option">
                  <span class="option-text">ARIYANTO</span>
                </li>
                <li class="option">
                  
                  <span class="option-text">BUDI SENTOSA</span>
                </li>
                <li class="option">
                  
                  <span class="option-text">DEDHI HARYANTO</span>
                </li>
                <li class="option">
                  
                  <span class="option-text">DODI ADRIANTO</span>
                </li>
                <li class="option">
                  
                  <span class="option-text">EDDY SUPARWOTO</span>
                </li><li class="option">
                  
                  <span class="option-text">ELIYA</span>
                </li><li class="option">
                  
                  <span class="option-text">ELVIRA ATIKA</span>
                </li><li class="option">
                  
                  <span class="option-text">FIRNIATI MARWIANINGSIH</span>
                </li><li class="option">

                  <span class="option-text">JULIAN RAMADHONI</span>
                </li><li class="option">

                  <span class="option-text">MAGDALENA</span>
                </li><li class="option">
                  
                  <span class="option-text">MGS ALI IWAN</span>
                </li><li class="option">
                  
                  <span class="option-text">MOEHAMMAD WIRAYUDHA</span>
                </li><li class="option">
                  
                  <span class="option-text">NENNY INDARYANTI</span>
                </li><li class="option">
                  
                  <span class="option-text">NOVITA HERIANI</span>
                </li><li class="option">
                  
                  <span class="option-text">NUR AISYAH KURNIATI</span>
                </li><li class="option">
                  
                  <span class="option-text">RIAN SUHENDRA</span>
                </li><li class="option">
                  
                  <span class="option-text">SRI WARDHANI</span>
                </li><li class="option">
                  
                  <span class="option-text">SUPARMAN</span>
                </li><li class="option">
                  
                  <span class="option-text">VANDI YASRIZA</span>
                </li><li class="option">
                  
                  <span class="option-text">YEPI ARDANI</span>
                </li><li class="option">
                 
                  <span class="option-text">YUNITA KAMILYA</span>
                </li>
              </ul>
            </div>
      ...
      <div class="question">
        <label class="question-label">TUGAS DAN TANGGUNG JAWAB</label>
        <br />
        <div class="rating">
        ...
        <div class="question">
          <label class="question-label">HASIL KERJA</label>
          <br />
          <div class="rating">
